"""Case 1 experiment DGP for VCTR."""
...
class Case1BaselineDGP(BaseDGP):
    """Case 1 DGP aligned with the original reduced-feature simulation setup.

    This class is intentionally self-contained for now. It supports the four
    coefficient-function forms and the two noise types used in the MATLAB
    Case 1 repetition script.
    """
    ...
    def sample(self, seed: int | None = None) -> SimulationDataset:
        """Generate one Case 1 reduced-feature dataset."""
