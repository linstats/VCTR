"""Paired-eye Case 2 DGP in reduced-feature space."""
...
class PairedCase2DGP(BasePairedDGP):
    """Paired-eye analogue of the archived iid Case 2 reduced-feature DGP."""
    ...
    def sample(self, seed: int | None = None) -> PairedEyeDataset:
        """Generate one paired-eye Case 2 dataset."""
    ...
    def _validate_parameters(self) -> None:
        """Validate Case 2 paired DGP parameters."""
    ...
    def _resolve_beta_true(self) -> np.ndarray:
        """Return the true beta vector for the paired Case 2 DGP."""
