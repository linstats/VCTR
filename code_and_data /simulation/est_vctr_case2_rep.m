% this is the code to reproduce experiment results in case II.

% in this code, we simulate 3D cases and use kernel smoothing method to 
% estimate function A(t), together with one-way coefficient \beta.
% This code is to repeat our case II.
...
fprintf(['This is repeated experiment for case 2,\n' ...
