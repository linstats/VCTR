% This is the code of evaluate parameters of simulation study - case 3.
...
mae_beta = mean(abs(beta_est - beta_hat));
rmse_beta = sqrt(mean((beta_est - beta_hat).^2));
...
XZ_const_nonzero_est = XZ_const_nonzero(id_est, :);
...
mae_beta = mean(abs(beta_hat_ref-beta));
rmse_beta = sqrt(mean((beta_hat_ref-beta).^2));
