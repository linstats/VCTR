% this is the code to reproduce experiment results in case III.

% in this code, we explore our model performance faced with different
% covariate correlations, together with the ability on identifying model 
% structure and detecting sparsity.
% This code is to repeat our case III.

% we set covariate correlation \rho = 0.1,0.5,0.9
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% for different rho and penalty type
for rho = [0.1, 0.5, 0.9]
...
for i_rep = 1:n_rep
fprintf('This is %d-th repeat for %s pentype and rho=%.1f \n', i_rep, pentype, rho)
...
fprintf(['This is repeated experiment for case 3,\n' ...
    'rho = %.4f, penalty type is %s, the penalty of parameters are %.4f,%.4f,%.4f,\n' ...
    ...
    rho, pentype, penparam_beta, penparam_gamma_c, penparam_gamma_v,...
